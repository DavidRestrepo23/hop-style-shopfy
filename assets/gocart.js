				...
				function GoCart(t) {
					...
					;(this.defaults = Object.assign(
						{},
						{
							...
							cartTrigger: ".js-go-cart-trigger, js-go-cart-abrir",
							cartOverlay: ".js-go-cart-overlay",
							cartCount: ".js-go-cart-counter",
							cartCountMobile: ".gocart-button-mobile-span",
							...
							labelCartIsEmpty: "<div><p>Your shopping bag is <span>empty</span></p> <a href='/collections/all' class='btn btn-primary with-arrow'>View Products </a> </div>",
							labelQuantity: "Quantity:",
							labelRemove:
								"<svg width='20' height='20' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M10 1.33337H6C5.26467 1.33337 4.66667 1.93137 4.66667 2.66671V4.00004H2V5.33337H3.33333V13.3334C3.33333 14.0687 3.93133 14.6667 4.66667 14.6667H11.3333C12.0687 14.6667 12.6667 14.0687 12.6667 13.3334V5.33337H14V4.00004H11.3333V2.66671C11.3333 1.93137 10.7353 1.33337 10 1.33337ZM6 2.66671H10V4.00004H6V2.66671ZM11.3333 13.3334H4.66667V5.33337H11.3333V13.3334Z' fill='#fff'/></svg>",
						},
						t,
					)),
						...
						(this.cartCountMobile = document.querySelector(this.defaults.cartCountMobile)),
					...
					(e = [
						...
						},
						{
							...
							value: function (t) {
								...
								window
									...
									.then(function (t) {
										$(".go-cart-drawer__content").removeClass("not-products");
						...
						},
						{
							...
							value: function (t) {
								...
								this.cartCountMobile.innerHTML = `${t.item_count}`
							},
						},
						{
										...
										var o = `
											...
											<div class="go-cart-item__single" data-line="${Number(r + 1)}">
												<div class="go-cart-item__info-wrapper">
														...
														<div class="go-cart-item__info">
															<div>
																<a href="${t.url}"><h3 class="go-cart-item__title">${t.product_title}</h3></a>
															</div>
															<div>
																<span class="go-cart-item__price">${formatMoney(t.line_price, e.moneyFormat)}</span>
															</div>
															...
															<div class="go-cart__variant_title">
																<span>${t.variant_title}</span>
															</div>
														</div>
														
												</div>
												<a class="btn btn-primary small go-cart-item__remove js-go-cart-remove-from-cart"><svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.33337H6C5.26467 1.33337 4.66667 1.93137 4.66667 2.66671V4.00004H2V5.33337H3.33333V13.3334C3.33333 14.0687 3.93133 14.6667 4.66667 14.6667H11.3333C12.0687 14.6667 12.6667 14.0687 12.6667 13.3334V5.33337H14V4.00004H11.3333V2.66671C11.3333 1.93137 10.7353 1.33337 10 1.33337ZM6 2.66671H10V4.00004H6V2.66671ZM11.3333 13.3334H4.66667V5.33337H11.3333V13.3334Z" fill="#ffffff"></path></svg></a>
											</div>
										`;
										...
										var o =
											'\n        <div class="go-cart-item__single" data-line="'
												...
												.concat(
													...
													'</div>\n            <a class="btn btn-primary small go-cart-item__remove ',
												)
						...
						},
						{
							...
							value: function () {
								this.cartDrawerSubTotal.parentNode.classList.add(
									...
									this.clearCartDrawer(),
									$(".go-cart-drawer__content").addClass("not-products");
